...
resource "aws_ses_email_identity" "drprado_email_identity" {
  email = "drprado2@gmail.com"
}

resource "aws_ses_email_identity" "mariaaug_email_identity" {
  email = "mariaaug222@gmail.com"
}

resource "aws_ses_email_identity" "joaoaug_email_identity" {
  email = "joaoaug222@gmail.com"
}

resource "aws_ses_email_identity" "drpradooutlook_email_identity" {
  email = "drprado2@outlook.com"
}
